...
tippy('.frends__form', {
    content: 'Бонус выплачивается за друга-курьера, так и за друга-пиццамейкера. Максимальный бонус за друга-курьера составляет 30 тыс. руб. а за друга на кухне 10 тыс. руб.',
    theme: "New style",
}); 
